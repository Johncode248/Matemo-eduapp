...
class Zad_dod_20 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Dod20)
        ...
        sprawdz_bt.setOnClickListener {
            ...
            if (odp == cor) {
                ...
                if (counter == maxQuestions) {
                    ...
                    val cursor = db.query(
                        TABLE_NAME, arrayOf(COLUMN_NAME_COUNT), null, null, null, null, null
                    )
                    cursor.moveToFirst()
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            val x1 = Random.nextInt(1, 20)
            val x2 = (1..(20 - x1)).random()
