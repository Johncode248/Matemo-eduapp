...
class Zad_dziel_tab_100 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Dzieltab100)
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(2, 21)
            var x2 = Random.nextInt(2, 21)

            while (x1 % x2 != 0) {
                x1 = Random.nextInt(2, 21)
                x2 = Random.nextInt(2, 21)
            }
