...
class Zad_dziel_tab_200 : AppCompatActivity() {


    private var counter = 0
    private val maxQuestions = 7
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Dzieltab200)
        ...
        btn_x.setOnClickListener {
            val intent = Intent(this, cls_dzielenie::class.java)
            startActivity(intent)
        }
        ...
        sprawdz_bt.setOnClickListener {
            ...
            if (odp == cor) {
                ...
                if (counter == maxQuestions) {
                    ...
                    odpowiednia_wartosc = 49 - (incorrect * 7)
                    if (corrrect == 7) {
                        odpowiednia_wartosc++
                    }
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(2, 201)
            var x2 = Random.nextInt(2, 201)

            while (x1 % x2 != 0) {
                x1 = Random.nextInt(2, 201)
                x2 = Random.nextInt(2, 201)
            }
