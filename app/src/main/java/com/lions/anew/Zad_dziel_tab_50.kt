...
class Zad_dziel_tab_50 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Dzieltab50)
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(1, 51)
            var x2 = Random.nextInt(1, 51)

            while (x1 % x2 != 0) {
                x1 = Random.nextInt(1, 51)
                x2 = Random.nextInt(1, 51)
            }
