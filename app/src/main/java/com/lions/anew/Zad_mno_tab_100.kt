...
class Zad_mno_tab_100 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Mnotab100)
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(2, 11)
            var x2 = Random.nextInt(2, 11)

            while (x1 * x2 > 100) {
                x1 = Random.nextInt(2, 11)
                x2 = Random.nextInt(2, 11)
            }
