...
class Zad_mno_tab_50 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Mnotab50)
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(2, 51)
            var x2 = Random.nextInt(2, 51)

            while (x1 * x2 > 50) {
                x1 = Random.nextInt(2, 51)
                x2 = Random.nextInt(2, 51)
            }
