...
class Zad_ode_3liczby : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText(R.string.Ode3do100)
        ...
        btn_x.setOnClickListener {
            val intent = Intent(this, cls_Dodawanie::class.java)
            startActivity(intent)
        }
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(1, 100)
            var x2 = (1..(100 - x1)).random()
            var x3 = (1..(100 - x1 - x2)).random()

            while (x1 - x2 - x3 < 0) {
                x1 = Random.nextInt(1, 100)
                x2 = (1..(100 - x1)).random()
                x3 = (1..(100 - x1 - x2)).random()
            }
