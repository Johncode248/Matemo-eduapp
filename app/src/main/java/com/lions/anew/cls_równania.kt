...
class cls_równania : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tytul_zadanie.setText("Dodawanie do 100")
        ...
        jeszcze_raz_zad.setOnClickListener {
            val intent = Intent(this, cls_równania::class.java)
        ...
        sprawdz_bt.setOnClickListener {
            var odp = textInput.text.toString()
            val cor = (pairs.elementAt(counter).second - pairs.elementAt(counter).first).toString()
            if (odp == cor) {
                ...
                if (counter == maxQuestions) {
                    ...
                    zmienna_poprawnie.setText("Poprawnie $corrrect")
                    zmienna_blednie.setText("Błędnie $incorrect")
                ...
                right_result.setText("$x111 $odp $x222")
                right_result.visibility = View.VISIBLE
                popr_odp.setText("$x111 $cor $x222")
    ...
    fun generateQuestion(textwyr: TextView) {
        ...
        do {
            var x1 = Random.nextInt(10, 86)
            var x2 = (15..(100 - x1)).random()

            while(x1>x2) {
                 x1 = Random.nextInt(10, 86)
                 x2 = (15..(100 - x1)).random()
            }
        ...
        pairs.add(pair)
        textwyr.setText("${pair.first} +")
        jack.setText("= ${pair.second}")
    }
}
